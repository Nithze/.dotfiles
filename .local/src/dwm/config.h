...
static char normbgcolor[]           = "#0a0a0d";
static char normbordercolor[]       = "#0a0a0d";
static char normfgcolor[]           = "#bbbbbb";
static char selfgcolor[]            = "#0a0a0d";
static char selbordercolor[]        = "#9498a6";
static char selbgcolor[]            = "#9498a6";
// static char selbordercolor[]        = "#7f00ff";
// static char selbgcolor[]            = "#7f00ff";
...
static const char *tags[] = { "1:dev", "2:term", "3:web", "4:dox", "5:gfx", "6", "7", "8", "9" };
...
static Key keys[] = {
 ...
 /* { 0, XF86XK_MonBrightnessUp,	spawn,		{.v = (const char*[]){ "light", "-A", "15", NULL } } },
  ...
  { 0, XF86XK_MonBrightnessUp,    spawn,    {.v = (const char*[]){ "xrandr", "--output", "eDP-1", "--brightness", "1.00", NULL } } },
  { 0, XF86XK_MonBrightnessDown,  spawn,    {.v = (const char*[]){ "xrandr", "--output", "eDP-1", "--brightness", "0.70", NULL } } },
  ...
  { MODKEY,	        		XK_m,		  spawn,		{.v = (const char*[]){ "mounter", NULL } } },
	{ MODKEY,			        XK_u,		  spawn,		{.v = (const char*[]){ "unmounter", NULL } } },
